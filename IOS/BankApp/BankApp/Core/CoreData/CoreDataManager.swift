...
class CoreDataManager {
    ...
    func saveMortgage(for user: CDUser, amount: Double, termYears: Int, rate: Double, monthly: Double, total: Double, overpay: Double) {
        ...
        mortgage.date = Date()
        mortgage.user = user  // связали с пользователем
        
        saveContext()
    }

    
    func saveLoan(amount: Double, termMonths: Int, rate: Double, monthlyPayment: Double, totalAmount: Double, user: CDUser) {
    ...
    func saveDeposit(amount: Double, termMonths: Int, interestRate: Double, totalInterest: Double, user: CDUser) {
